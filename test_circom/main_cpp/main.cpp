...
void Verifier_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Verifier_2_run(uint ctx_index,Circom_CalcWit* ctx);
...
Verifier_2_create(1,0,ctx,"main",0);
Verifier_2_run(0,ctx);
}
